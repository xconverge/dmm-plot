...
def handle_messages():
    # make working copy of dict to make sure values don't change
    messages = dict(cur_msg)
...
for source in sources:
    readthread = reader.ThreadedReader(
        source, value_callback=store_message, error_callback=delete_message, filewait=filewait)
